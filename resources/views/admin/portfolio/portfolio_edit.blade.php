                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.portfolio') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="example-text" class="col-sm-2 col-form-label">Portfolio Title</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="portfolio_title" type="text"  value="{{ $portfolio->portfolio_title }}" id="example-text">
                            ...
                            <div class="row mb-3">
                                <label for="long-rext" class="col-sm-2 col-form-label">Portfolio Description</label>
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="portfolio_description" id="long-text">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="card-img-top img-fluid rounded avatar-lg" src="{{ asset($portfolio->portfolio_image) }}" alt="Card image cap">
                                </div>
                            </div>
